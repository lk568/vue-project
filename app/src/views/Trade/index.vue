  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ userEndAddress.userAddress }}</span>
        收货人: <span>{{ userEndAddress.consignee }}</span> 手机号:
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      // 其余6个参数
      let data = {
        consignee: this.userEndAddress.consignee, //最终收件人名字
        consigneeTel: this.userEndAddress.phoneNum, //最终收件人手机号
        deliveryAddress: this.userEndAddress.fullAddress, //最终收件人地址
        paymentWay: "ONLINE", //支付方式（只有在线支付）
        orderComment: this.msg, //买家留言信息
        orderDetailList: this.orderInfo.detailArrayList || [], //购物车商品清单
      };
      // api,需要带参数：tradeNo,data
